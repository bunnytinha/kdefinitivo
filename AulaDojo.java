...
public class AulaDojo extends JFrame implements ActionListener, ItemListener{
      ...
      private ImageIcon bm = new ImageIcon("C:/Dojo/Imagens/bannerdojo.png");
      ...
      private ImageIcon iconferir = new ImageIcon("C:/Dojo/Imagens/checar.png");
      private JLabel lbconferir = new JLabel(iconferir);
      private ImageIcon iind = new ImageIcon("C:/Dojo/Imagens/indicador.png");
      private JLabel ind = new JLabel(iind);
      private ImageIcon iind1 = new ImageIcon("C:/Dojo/Imagens/indicador1.png");
      ...
      public AulaDojo(){
            ...
            lbconferir.setBounds(centroW-170,centroH-201,200,30);
            ...
            presenca1.setBounds(centroW,centroH+50,100,24);
            atribuirP.setBounds(centroW+110,centroH+50,200,25);
            notaP.setBounds(centroW-100, centroH+50,100,25);
            copiloto.setBounds(centroW-310,centroH+85,200,25);
            presenca.setBounds(centroW,centroH+85,100,24);
            notaC.setBounds(centroW-100, centroH+85,100,25);
