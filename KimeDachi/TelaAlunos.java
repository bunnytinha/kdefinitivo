...
public class TelaAlunos extends JFrame implements ActionListener{
   ...
   private ImageIcon ialunos = new ImageIcon("../Imagens/listaAlunos1.png");    
   private JLabel lbalunos = new JLabel(ialunos);
   private ImageIcon iperguntas = new ImageIcon("../Imagens/cadastrarAlunos.png");
   private JLabel lbperguntas = new JLabel(iperguntas);
   private ImageIcon idojo = new ImageIcon("../Imagens/alterarAlunos1.png");
