...
public class ListaDeAluno extends JFrame implements ActionListener, ItemListener, ListSelectionListener{
      ...
      private ImageIcon bm = new ImageIcon("C:/Dojo/Imagens/bannerlista.png");
      ...
      public ListaDeAluno(){
         ...
         filtroA.setBounds(centroW-20,centroH-370,200,100);
         filtro.setBounds(centroW-150,centroH-300,300,19);
